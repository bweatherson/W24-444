...
Abraham Roth (in the Stanford Encyclopedia of Philosophy article on
Shared Agency) says that on Margaret Gilbert's view of shared action,
...
Jessica Brown describes Jennifer Lackey's theory of group belief as a
`neo-summative' (3168), and goes on to argue against it. Describe
Lackey's theory, and (at least one of) Brown's objections to it. How
might Lackey reply to Brown?

\subsection*{Question Three}\label{question-three}
\addcontentsline{toc}{subsection}{Question Three}

In ``Groupthink'', Russell, Hawthorne and Buchak argue against using
arithmetic averaging to come up with group probabilities. Describe their
arguments, and say what a defender of arithmetic averaging might say in
response.

\subsection{Due Date}\label{due-date}

Essays are due Friday, February 9, 2024 at 5pm.
